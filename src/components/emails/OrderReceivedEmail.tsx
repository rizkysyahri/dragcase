        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={{ ...global.text, marginTop: 24 }}>
              ...
              contact us with your order number and we're heer for help.
            </Text>
          </Section>
          <Hr style={global.hr} />
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Please contact us if you have any quetions. (If you reply to
                this email, we won't be able to see it.)
              </Text>
            </Row>
            <Row>
              <Text style={footer.text}>
                © DragCase, Inc. All Rights Reserved.
              </Text>
            </Row>
          </Section>
        </Container>
